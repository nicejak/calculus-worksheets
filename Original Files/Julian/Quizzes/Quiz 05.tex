...
\begin{document} 
Consider the function $f(x) = x^3(x-4) = x^4-4x^3.$ 
\begin{enumerate}
    \item Find the critical values of $f(x)$.
    \vfill
    \item Use your answer above to find the absolute min and maximum of $f$ on the interval $[1,6]$. This may be helpful: $6^3 = 216.$
    \vfill
\end{enumerate}
