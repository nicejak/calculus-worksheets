...
\ExamClass{Math 242}
\ExamName{Classwork 05: \S7.4, 7.5}
\ExamHead{Fall 2024}
\fancyfoot{}
...
\begin{document}
    ...
    \begin{enumerate}
        \item Use the method of partial fractions to integrate $$\int\frac{x^{2}+2x+1}{(x^{2}+1)^{2}}dx.$$
        \newpage
        \item Use the method of partial fractions to integrate $$\int\frac{2x^{3}-2x^{2}+1}{x^{2}-x}dx.$$
        \newpage
