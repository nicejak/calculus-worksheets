...
\newcommand{\MyAssignment}{Classwork 05}
...
\vfill
\item \[\int \tan x \sec^5 x \:dx\]
\vfill
\item \[ \int \sqrt{\sin \theta} \cos^3 \theta \: d\theta  \]
\vfill
\newpage


\item \[\int \frac{dt}{t^2\sqrt{t^2-16}}\]
\vfill

 

\item \[\int \sqrt{x^2+2x} \:dx\]
